...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep 23 18:17:56 2022

@author: Avery Schebell ajs6av
"""
# link to github repo

#https://github.com/aschebell/DS2002-mywork
...
#Let’s first create a .db file, as this is a very standard way of actually maintaining a SQLite database.
#We’ll represent the connection using a variable named conn. We’ll create a file called orders.db.

#conn = sqlite3.connect('orders.db')
conn = sqlite3.connect(r'/Users/Avery/DS2002/orders.db')

# a cursor object allows us to execute SQL queries against a database. 
# We’ll create a variable cur to hold our cursor object:
...
# Say we wanted to return more than only one result, we could use the fetchmany() function. 
# Let’s run a different script to generate 3 results:
cur.execute("SELECT * FROM users;")
three_results = cur.fetchmany(3)
print(three_results)

# Similarly, we could use the fetchall() function to return all the results. 
# If we ran the following, all results would be returned:
cur.execute("SELECT * FROM users;")
